...
\draw[color=black] (2,1.2) node {5};
\draw[color=black] (2,0) node {$21$};
\draw[color=black] (2,-.8) node {1};
\draw[color=black] (3,1) node {$11$};
\draw[color=black] (3,.2) node {2};
\draw[color=black] (3.5,3) node {$14$};
\draw[color=black] (3.5,2.2) node {9};
...
\draw[color=black] (11.5,1.2) node {5};

\draw[color=black] (11.5,0) node {$44$};
\draw[color=black] (11.5,-.8) node {1};

\draw[color=black] (12.5,1) node {$41$};
\draw[color=black] (12.5,.2) node {3};


\draw[color=black] (13.5,0) node {$11$};
\draw[color=black] (13.5,-.8) node {1};
