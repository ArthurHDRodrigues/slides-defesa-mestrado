...
\draw (3.95,2) node[anchor=south] {{\Large $\hat z$}};
\draw [fill=black] (6,2) circle (2.5pt);
\draw (6,2) node[anchor=south] {{\Large $\hat y$}};

\draw [fill=black] (2,5) circle (2.5pt);
\draw (2,5) node[anchor=south east] {{\Large $\hat F_0$}};
\draw [fill=black] (2,2) circle (2.5pt);
\draw (2,2) node[anchor=west] {{\Large $\hat F_1$}};
\draw [fill=black] (0,2) circle (2.5pt);
\draw (0,2) node[anchor=south] {{\Large $\hat F_2$}};
\draw [fill=black] (7,2) circle (2.5pt);
\draw (7,2) node[anchor=west] {{\Large $\hat F_3$}};


\draw (-.7,2.4) node[anchor=north] {{\Large $\hat a$}};
\draw (-.5,2) node[anchor=north] {{\Large $\hat a_1$}};
\draw (-1.2,2.05) node[anchor=north] {{\Large $\hat a_3$}};
%\draw (-1,2.4) node[anchor=north] {$2$}};

\draw (1.1,2.5) node[anchor=north] {{\Large $\hat b$}};
\draw (.6,2.7) node[anchor=north] {{\Large $\hat b_0$}};
\draw (.6,2) node[anchor=north] {{\Large $\hat b_2$}};
%\draw (1,2) node[anchor=north] {$7$}};

\draw (2.45,3.3) node[anchor=north] {{\Large $\hat c$}}; % u -- w
\draw (2.8,3.05) node[anchor=north] {{\Large $\hat c_0$}}; % u -- w
\draw (2.1,3) node[anchor=north] {{\Large $\hat c_2$}}; % u -- w
%\draw (2.55,2.7) node[anchor=north] {$3$}}; % u -- w

\draw (2.45,1.6) node[anchor=north] {{\Large $\hat d$}}; % v -- w
\draw (2,1.7) node[anchor=north] {{\Large $\hat d_3$}}; % v -- w
\draw (2.4,1) node[anchor=north] {{\Large $\hat d_1$}}; % v -- w
%\draw (2.5,1.3) node[anchor=north] {$1$}}; % v -- w

\draw (5.1,2.45) node[anchor=north] {{\Large $\hat g$}}; % v -- w
\draw (5.2,2.8) node[anchor=north] {{\Large $\hat g_3$}}; % v -- w
\draw (5.2,1.8) node[anchor=north] {{\Large $\hat g_1$}}; % v -- w
%\draw (2.5,1.3) node[anchor=north] {$1$}}; % v -- w

\draw (7.04,3.2) node[anchor=north] {{\Large $\hat f$}}; % w -- w
\draw (7.4,3.3) node[anchor=north] {{\Large $\hat f_2$}}; % w -- w
\draw (6.5,3) node[anchor=north] {{\Large $\hat f_0$}}; % w -- w
