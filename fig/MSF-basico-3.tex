...
\draw [fill=black] (-.83,2) circle (2.5pt);
\draw [fill=black] (-1.1,2) circle (2.5pt);
...
\draw [fill=black] (.8,2.3) circle (2.5pt);
\draw [fill=black] (.8,1.7) circle (2.5pt);
...
\draw [fill=black] (2.2,2.9) circle (2.5pt);
\draw [fill=black] (2.54,2.9) circle (2.5pt);
\draw [fill=black] (2.7,2.65) circle (2.5pt);
...
\draw [fill=black] (2.35,1.175) circle (2.5pt);
\draw [fill=black] (2.2,1.5) circle (2.5pt);
\draw [fill=black] (2.5,.9) circle (2.5pt);

% Aresta e
\draw [line width=2pt,color=cyan] (4,2) to  (6,2);   
\draw [line width=.5pt] (4,2) to  (6,2);   
\draw [fill=black] (5,2.5) circle (2.5pt);
\draw [fill=black] (5,2) circle (2.5pt);
\draw [fill=black] (5,1.5) circle (2.5pt);
...
\draw [fill=black] (6.9,2.75) circle (2.5pt);
\draw [fill=black] (6.5,2.5) circle (2.5pt);
\draw [fill=black] (7.4,2.8) circle (2.5pt);


\draw [fill=black] (0,4) circle (2.5pt);
\draw (0,4) node[anchor=south east] {{\Large $\hat u$}};

\draw [fill=black] (0,0) circle (2.5pt);
\draw (0,0) node[anchor=north east] {{\Large $\hat v$}};
\draw [fill=black] (4,2) circle (2.5pt);
\draw (4,2.1) node[anchor=south] {{\Large $\hat z$}};
\draw [fill=black] (6,2) circle (2.5pt);
\draw (5.9,2) node[anchor=south] {{\Large $\hat y$}};

\draw [fill=black] (2,5) circle (2.5pt);
\draw (2,5) node[anchor=south east] {{\Large $\hat F_0$}};
\draw [fill=black] (2,2) circle (2.5pt);
\draw (2.2,2) node[anchor=west] {{\Large $\hat F_1$}};
\draw [fill=black] (0,2) circle (2.5pt);
\draw (0,2.1) node[anchor=south] {{\Large $\hat F_2$}};
\draw [fill=black] (7,2) circle (2.5pt);
\draw (7,2) node[anchor=west] {{\Large $\hat F_3$}};


\draw (-1,2.5) node[anchor=north] {{\Large $\hat a$}};
\draw (-.5,1.9) node[anchor=north] {{\Large $\hat a_1$}};
\draw (-1.2,2.05) node[anchor=north] {{\Large $\hat a_3$}};
%\draw (-1,2.4) node[anchor=north] {$2$}};

\draw (1.1,2.55) node[anchor=north] {{\Large $\hat b$}};
\draw (.53,2.7) node[anchor=north] {{\Large $\hat b_0$}};
\draw (.55,2) node[anchor=north] {{\Large $\hat b_2$}};
%\draw (1,2) node[anchor=north] {$7$}};

\draw (2.4,3.35) node[anchor=north] {{\Large $\hat c$}}; % u -- w
\draw (2.95,3.05) node[anchor=north] {{\Large $\hat c_0$}}; % u -- w
\draw (2.1,3) node[anchor=north] {{\Large $\hat c_2$}}; % u -- w
%\draw (2.55,2.7) node[anchor=north] {$3$}}; % u -- w

\draw (2.45,1.8) node[anchor=north] {{\Large $\hat d$}}; % v -- w
\draw (1.95,1.8) node[anchor=north] {{\Large $\hat d_3$}}; % v -- w
\draw (2.4,.95) node[anchor=north] {{\Large $\hat d_1$}}; % v -- w
%\draw (2.5,1.3) node[anchor=north] {$1$}}; % v -- w

\draw (5.25,2.5) node[anchor=north] {{\Large $\hat g$}}; % v -- w
\draw (5.3,2.95) node[anchor=north] {{\Large $\hat g_3$}}; % v -- w
\draw (5.3,1.8) node[anchor=north] {{\Large $\hat g_1$}}; % v -- w
%\draw (2.5,1.3) node[anchor=north] {$1$}}; % v -- w

\draw (7.04,3.25) node[anchor=north] {{\Large $\hat f$}}; % w -- w
\draw (7.4,3.45) node[anchor=north] {{\Large $\hat f_2$}}; % w -- w
\draw (6.5,3.15) node[anchor=north] {{\Large $\hat f_0$}}; % w -- w
