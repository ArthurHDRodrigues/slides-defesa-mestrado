...
\draw [line width=1pt] (2,0) circle (0.5cm);
\draw [line width=1pt] (4.5,1) circle (0.5cm);
\draw [line width=1pt] (10.5,-1) circle (0.5cm);
\draw [line width=1pt] (7.5,0) circle (0.5cm);
\draw [line width=1pt] (9.5,0) circle (0.5cm);
\draw [line width=1pt] (11.5,0) circle (0.5cm);
\draw [line width=1pt] (13.5,0) circle (0.5cm);
\draw [line width=1pt] (0.3535533905932738,0.3535533905932738)-- (0.6464466094067263,0.6464466094067263);
...
\draw [line width=1pt] (2.646446609406726,0.646446609406726)-- (2.353553390593274,0.35355339059327395);
...
\draw [line width=1pt] (12.146446609406727,0.6464466094067269)-- (11.853553390593273,0.35355339059327306);
\draw [line width=1pt] (9.853553390593273,-0.35355339059327306)-- (10.146446609406727,-0.6464466094067269);
\draw [line width=1pt] (12.853553390593273,0.6464466094067269)-- (13.146446609406727,0.35355339059327306);
\draw[color=black] (0,0) node {$11$};
\draw[color=black] (0,-.8) node {1};
\draw[color=black] (1,1) node {$12$};
\draw[color=black] (1,.2) node {2};
\draw[color=black] (2,2) node {$22$};
\draw[color=black] (2,1.2) node {3};
\draw[color=black] (2,0) node {$21$};
\draw[color=black] (2,-.8) node {4};
\draw[color=black] (3,1) node {$11$};
\draw[color=black] (3,.2) node {5};
\draw[color=black] (3.5,3) node {$14$};
\draw[color=black] (3.5,2.2) node {6};
\draw[color=black] (4.5,1) node {$44$};
\draw[color=black] (4.5,.2) node {7};
\draw[color=black] (5.5,2) node {$45$};
\draw[color=black] (5.5,1.2) node {8};
\draw[color=black] (6.5,1) node {$55$};
\draw[color=black] (6.5,.2) node {9};
\draw[color=black] (7,4) node {$54$};
\draw[color=black] (7,3.2) node {10};

\draw[color=black] (7.5,0) node {$44$};
\draw[color=black] (7.5,-.8) node {11};

\draw[color=black] (8.5,1) node {$40$};
\draw[color=black] (8.5,.2) node {12};

\draw[color=black] (9.5,0) node {$00$};
\draw[color=black] (9.5,-.8) node {13};

\draw[color=black] (10.5,-1) node {$04$};
\draw[color=black] (10.5,-1.8) node {14};

\draw[color=black] (9.5,2) node {$44$};
\draw[color=black] (9.5,1.2) node {15};


\draw[color=black] (10.5,3) node {$43$};
\draw[color=black] (10.5,2.2) node {16};

\draw[color=black] (10.5,1) node {$33$};
\draw[color=black] (10.5,.2) node {17};


\draw[color=black] (11.5,2) node {$34$};
\draw[color=black] (11.5,1.2) node {18};

\draw[color=black] (11.5,0) node {$44$};
\draw[color=black] (11.5,-.8) node {19};

\draw[color=black] (12.5,1) node {$41$};
\draw[color=black] (12.5,.2) node {20};


\draw[color=black] (13.5,0) node {$11$};
\draw[color=black] (13.5,-.8) node {21};
