...
\draw (1,2.5) node {{\Large $F_0$}};
%\draw [fill=black] (1,1) circle (1.5pt);
\draw (1.2,1) node {{\Large $F_1$}};
%\draw [fill=black] (0,1) circle (1.5pt);
\draw (0,1) node {{\Large $F_2$}};
%\draw [fill=black] (2.5,1) circle (1.5pt);
\draw (3.5,1) node {{\Large $F_3$}};

%\draw (-0.3,1) node {{\Large $2$}};
\draw (-0.6,1) node {{\Large $a$}};

\draw (0.55,1.) node {{\Large $b$}};
%\draw (0.53,1) node {{\Large $7$}};

\draw (1.15,1.8) node[anchor=north] {{\Large $c$}}; % u -- w
%\draw (1.05,1.5) node[anchor=north] {{\Large $3$}}; % u -- w

\draw (1.2,.65) node[anchor=north] {{\Large $d$}}; % v -- w
%\draw (1.35,.65) node[anchor=north] {{\Large $1$}}; % v -- w

\draw (2.5,1) node[anchor=north] {{\Large $g$}}; % v -- w
%\draw (2.5,.95) node[anchor=north] {{\Large $4$}}; % v -- w


\draw (4.2,1) node {{\Large $f$}}; % w -- w
