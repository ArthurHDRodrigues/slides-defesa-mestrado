...
\input{fig/ABB-novono}
\end{minipage}
\begin{minipage}[H]{0.4\textwidth}
\input{fig/ABB-raiz}
\end{minipage}
\boxpurple{\centering  \treapCreate{}:~$\O{1}$.\\
	\treapGetRoot($\node$):~$\O{\lg n}$.}
\end{frame}
...
\begin{figure}[H]
\input{fig/ABB-piramide}
\end{figure}
\end{minipage}
\begin{minipage}[H]{0.4\textwidth}
\begin{figure}[H]
\input{fig/ABB-corta-sequencia}
\end{figure}
\boxpurple{\centering  \treapSplit{}:~$\O{\lg n}$.}
\end{minipage}
\end{frame}
...
\begin{minipage}[H]{0.5\textwidth}
\begin{figure}[H]
\input{fig/ABB-junta-piramides}
\end{figure}
\end{minipage}
\begin{minipage}[H]{0.4\textwidth}
\begin{figure}[H]
\input{fig/ABB-junta-sequencias}
\end{figure}
\boxpurple{\centering  \treapJoin{}:~$\O{\lg n}$.}
\end{minipage}
\end{frame}
...
\begin{figure}[H]
\input{fig/exemploSeqEulerColorida}
\end{figure}
\end{minipage}
\begin{minipage}{0.4\textwidth}
\begin{figure}
...
\begin{itemize}
    \item floresta maximal dinâmica~\TODO{$F$} de~$G$; e
    \item um grafo~$R$ = $G-\TODO{F}$
\end{itemize}
\end{block}
\begin{figure}[htb]
\scalebox{.5}{
\input{fig/exemplo-floresta-reserva.tex}
	}
\end{figure}
...
\item O código em \LaTeX{} da dissertação também está disponível.
\end{itemize}
\end{block}
\end{frame}
...
\begin{frame}{Criação de grafo plano ponderado dinâmico e consulta de peso}
\begin{algorithm}[H]
\caption{\MSFCreate($n$)}
