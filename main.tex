...
\end{itemize}
\end{exampleblock}
Para solucionar esse problema, vamos apresentar a estrutura de dados proposta por Henzinger e King~\cite{HenzingerKing}.
\end{frame}
...
\begin{frame}{Rotina para converter uma instância de VSP$S_k$ em uma instância de conexidade em grafos dinâmicos}
\begin{algorithm}[H]
